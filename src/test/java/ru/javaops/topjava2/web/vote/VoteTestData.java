...
public class VoteTestData {
    ...
    public static final Vote vote_user = new Vote(4, LocalDate.of(2023, 05, 10), null, 1, MONUMENT);
    public static final Vote vote_user_1 = new Vote(5, LocalDate.of(2023, 05, 10), null, 4, MONUMENT);
    public static final Vote vote_user_2 = new Vote(6, LocalDate.of(2023, 05, 10), null, 5, WALTER);
